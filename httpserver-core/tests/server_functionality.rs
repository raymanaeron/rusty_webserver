...
use httpserver_core::{Server, gateway_health, create_health_router, create_error_response, logging_middleware};
...
async fn test_error_response_content() {
    let response = create_error_response(StatusCode::INTERNAL_SERVER_ERROR, "Internal error occurred");
