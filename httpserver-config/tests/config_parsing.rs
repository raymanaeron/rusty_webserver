...
fn test_config_from_toml_file() {
    let temp_dir = create_test_directory();      let toml_content = format!(r#"[static_config]
directory = "{}"
fallback = "app.html"
...
fn test_config_with_multiple_targets() {
    let temp_dir = create_test_directory();      let toml_content = format!(r#"
[static_config]
directory = "{}"
...
#[test]
fn test_proxy_route_legacy_vs_new_targets() {    // Test legacy single target
